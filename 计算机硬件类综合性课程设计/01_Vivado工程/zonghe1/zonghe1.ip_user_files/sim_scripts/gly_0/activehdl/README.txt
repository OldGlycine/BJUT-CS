...
#
# Generated by export_simulation on Wed Jun 12 17:26:58 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './gly_0.sh' script.
...
./gly_0.sh -noclean_files

For more information on the script, please type './gly_0.sh -help'.
